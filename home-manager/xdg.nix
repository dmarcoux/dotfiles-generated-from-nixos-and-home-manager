...

{
  ...
  xdg = {
    ...
    # TODO: Go through the list below and update it to match the apps I use now with KDE
    mimeApps = {
      enable = true;
      defaultApplications = {
    ...
    #     "inode/directory" = "lf.desktop";
        ...
        # Uncomment this if I use Slack again
        # "x-scheme-handler/slack" = "slack.desktop";
    #     # TODO: Uncomment and update this if I start using another email client
    #     # "x-scheme-handler/mailto" = "thunderbird.desktop";
    # TODO: Uncomment this once I installed Chromium again
